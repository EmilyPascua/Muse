...
import com.cafemanager.musefoundation.Utils.MusicAdapter;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot singleSnapshot :  dataSnapshot.getChildren()){
                    ...
                    post.setArtistName(firebasePostMap.get(getString(R.string.firebase_artist_name)).toString());
                    post.setSongName(firebasePostMap.get(getString(R.string.firebase_song_name)).toString());
                    post.setAlbumImgUrl(firebasePostMap.get(getString(R.string.firebase_album_img_url)).toString());
                    post.setDescription(firebasePostMap.get(getString(R.string.firebase_description)).toString());
                    post.setSongPreview(firebasePostMap.get(getString(R.string.firebase_song_preview)).toString());
